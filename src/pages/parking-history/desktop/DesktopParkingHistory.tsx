      ...
      <div className='w-11/12'>
        ...
        <div className='flex flex-col items-center'>
          {items.map((item) => {
            return (
              <div
                className='mb-3 flex w-6/12 flex-col justify-between rounded border bg-white shadow-md'
                key={item.id}
                id={`${item.id}`}
                // onClick={}
              >
                ...
                <button
                  ...
                  className='mt-2 w-full border-t bg-neutral-100 p-1.5 font-medium shadow-md hover:bg-white hover:shadow-inner hover:shadow-neutral-200'
                >
                  Λεπτομέρειες
                </button>
              </div>
...
export default DesktopParkingHistory;
