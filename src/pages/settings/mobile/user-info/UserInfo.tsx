    ...
    <BasicLayout>
      ...
      >
        ...
        <div className='flex w-full flex-col items-center'>
          <Link
            to='/settings/user-info/personal-info'
            className='mb-2 flex w-11/12 items-center justify-between rounded border bg-white shadow-md'
          >
            <div className='px-4 py-2 font-medium'>Προσωπικά στοιχεία</div>
            <div className='p-2'>
              <svg
          ...
          <Link
            to='/settings/user-info/contact-info'
            className='mb-2 flex w-11/12 items-center justify-between rounded border bg-white shadow-md'
          >
            <div className='px-4 py-2 font-medium'>Στοιχεία επικοινωνίας</div>
            <div className='p-2'>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                className='h-6 w-6'
